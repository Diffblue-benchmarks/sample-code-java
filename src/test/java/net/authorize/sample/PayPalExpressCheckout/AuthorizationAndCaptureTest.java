...
public class AuthorizationAndCaptureTest {

  @Rule public final ExpectedException thrown = ExpectedException.none();

  @Test
  public void constructorOutputVoid() {
  	final AuthorizationAndCapture authorizationAndCapture = new AuthorizationAndCapture();
  }
  ...
  @PrepareForTest({CreateTransactionResponse.class, ApiOperationBase.class,
                   ...
                   AuthorizationAndCapture.class, PayPalType.class, PaymentType.class,
                   CreateTransactionController.class, TransactionTypeEnum.class})
  @Test
  public void
  runInputNullNullZeroOutputIndexOutOfBoundsException2() throws Exception {
    ...
    AuthorizationAndCapture.run(null, null, 0.0);
  }
  ...
  @PrepareForTest({ApiOperationBase.class, MerchantAuthenticationType.class,
                   ...
                   System.class, AuthorizationAndCapture.class, PayPalType.class, PaymentType.class,
                   CreateTransactionController.class, TransactionTypeEnum.class})
  @Test
  public void
  runInputNullNullZeroOutputNull() throws Exception {
    ...
    PowerMockito.whenNew(TransactionRequestType.class)
        .withNoArguments()
        .thenReturn(transactionRequestType);
	  Assert.assertNull(AuthorizationAndCapture.run(null, null, 0.0));
  }
